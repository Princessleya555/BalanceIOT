...
gauche = tk.Frame(corps, bg="#1e3a1e")  #Placement du coin caméra sur l'interface
gauche.pack(side="left", fill="both", expand=True, padx=(0, 6)) #Faire un pack signifie faire appel de la méthode

lbl_cam = tk.Label(gauche, bg="#000000", text="Démarrage caméra...", #Lancement de la caméra
                   fg="#6ddc4a", font=("Courier", 10), width=42, height=13) #fg(foreground) bg(background)
lbl_cam.pack(pady=6)

tk.Label(gauche, text="Choisissez le produit détecté :",  #texte
         font=("Courier", 10), bg="#1e3a1e", fg="#aaaaaa").pack()

btn1 = tk.Button(gauche, text="---", font=("Courier", 12, "bold"),  #Bouton 1
...
btn2 = tk.Button(gauche, text="---", font=("Courier", 12, "bold"),  #Boutton 2
                 bg="#2f4a2f", fg="#ddf0cc", bd=0, cursor="hand2", pady=10)
